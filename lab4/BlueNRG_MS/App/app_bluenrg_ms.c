 ...
 */
#define USE_BUTTON 0
#define DEFAULT_SAMPLING_PERIOD 1000
/* Private macros ------------------------------------------------------------*/
...
int16_t pDataXYZ[3];
extern uint16_t sampling_frequency;
...
//  static sampling_period = DEFAULT_SAMPLING_PERIOD;
//  static sampling_frequency = 1;
...
//      Quat_Update(&q_axes);
      ...
      Reset_Motion_Values();
#if !USE_BUTTON
      HAL_Delay(1000/sampling_frequency); /* wait 1 sec before sending new data */
#endif
    }
#if USE_BUTTON
